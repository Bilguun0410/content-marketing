  ...
  const layers = [
    {
      ...
      color: "var(--lime)",
      y: 0,
      items: ["Hook bank · 142", "Content calendar · 28 posts", "Pillar: Build in public"],
    },
    {
      label: "CONTENT",
      color: "var(--cyan)",
    ...
    },
    {
      ...
      color: "var(--violet)",
      y: 76,
      items: ["+24.8% engagement", "+1.2k followers / wk", "Best post: Tuesday 9am"],
    },
    {
      label: "MATCH",
      color: "var(--pink)",
  ...
  return (
    <div className="relative w-full aspect-square max-w-140 mx-auto">
      ...
      <div
        ...
        style={{
          inset: "-10%",
          background: "radial-gradient(circle at 50% 50%, rgba(34,211,238,0.18), transparent 60%)",
          filter: "blur(40px)",
        }}
      />
      {layers.map((l, i) => (
        <motion.div
          ...
          animate={{
            y: hover === i ? l.y - 8 : hover !== null && i > hover ? l.y + 12 : l.y,
            rotate: (i - 1.5) * 1.2,
          ...
          <div className="flex justify-between items-center mb-3">
            <div className="flex items-center gap-3">
              <div
                ...
                style={{ background: `linear-gradient(135deg, ${l.color}, ${l.color}66)` }}
              >
  ...
  return (
    <div className="relative w-full max-w-140 mx-auto aspect-square">
      <div className="relative h-full p-7 bg-bg-card border border-line-strong rounded-[22px]">
        ...
        <div className="font-mono text-[11px] text-muted tracking-widest">TOTAL REACH</div>
      ...
      <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full">
        {nodes.slice(1).map((n, i) => (
          <line
            ...
            stroke={i % 2 === 0 ? "rgba(34,211,238,0.35)" : "rgba(167,139,250,0.3)"}
            strokeWidth="0.3"
            strokeDasharray="0.5 0.6"
          >
            <animate attributeName="stroke-dashoffset" from="0" to="-10" dur={`${4 + i}s`} repeatCount="indefinite" />
          </line>
        ))}
      </svg>
      {nodes.map((n, i) => (
        ...
        <div className="grid grid-cols-[1.1fr_1fr] gap-16 items-center max-[980px]:grid-cols-1 max-[980px]:gap-14">
          <Reveal stagger className="flex flex-col gap-8">
            ...
            <h1 className="font-display text-[clamp(48px,7vw,96px)] font-medium tracking-[-0.03em] leading-[0.96] m-0">
              The growth stack <br />
              for{" "}
              <span className="text-grad">creators</span>{" "}
              &amp; brands.
            </h1>
            <p className="text-[clamp(17px,1.4vw,20px)] text-ink-soft max-w-135 leading-normal m-0">
              ...
              actually fit. Ship a quarter&apos;s worth of posts in an
              afternoon — without losing your voice.
            </p>
